                      ...
                      {countriesList.map(constraint => (
                        <FormCheck>
                          <FormCheck.Input
                            ...
                            onClick={() =>
                              updateConstraints('country', country, constraint, constraint.concat('CheckV'))
                            }
                          ></FormCheck.Input>
                      ...
                      <form>
                        <div class="form-group">
                          ...
                          <input
                            ...
                            id="minPrice"
                            placeholder="1"
                            onChange={() => updateNumConstraints('startPrice', 'minPrice')}
                          ></input>
                        </div>
                        <div class="form-group">
                          ...
                          <input
                            ...
                            id="maxPrice"
                            placeholder="4"
                            onChange={() => updateNumConstraints('endPrice', 'maxPrice')}
                          ></input>
                        </div>
                      </form>
                    </Container>
