...
it("Init Wine", () => {
    ...
    const component = renderer.create(<WineCard wine={wine} />);
  ...
  it("Init Vineyard", () => {
    ...
    const component = renderer.create(<VineyardCard vineyard={vineyard} />);
  ...
  "url": "https://www.tripadvisor.com/Tourism-g32660-Los_Olivos_California-Vacations.html",
    ...
    const component = renderer.create(<RegionCard region={region} />);
